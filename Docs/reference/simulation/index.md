...
| Targeted chains | Target-proxy chain walks that live exactly as long as their walk, with link falloff, line-segment VFX, and one reuse pool. | [targeted-system.md](./targeted-system.md) |
