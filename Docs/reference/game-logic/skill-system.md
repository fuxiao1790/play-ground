...
AOE and targeted prefabs have their own VFX slots, but do not have hit, expire,
pulse, or arming sound slots. See [Sound Events](../../contracts/sound-events.md)
for runtime timing, selection, and listener rules.
