...
namespace AgentVFX.Editor
{
    ...
    public sealed class AgentVfxNodeDto
    {
        ...
        public AgentVfxSettingDto[] settings;
    }

    [Serializable]
    public sealed class AgentVfxSettingDto
    {
        public string name;
    ...
    [Serializable]
    public sealed class AgentVfxFlowConnectionDto
    {
        public string fromNode;
    ...
    public sealed class AgentVfxGraphDto
    {
        ...
        public AgentVfxSlotDto[] slots;
        public AgentVfxConnectionDto[] connections;
        public AgentVfxFlowConnectionDto[] flowConnections;
        public AgentVfxBlackboardPropertyDto[] blackboard;
    }
