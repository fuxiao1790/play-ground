...
namespace AgentVFX.Internal
{
    ...
    public sealed class NodeSnapshot
    {
        ...
        public SettingSnapshot[] settings;
    }
    ...
    public sealed class GraphSnapshot
    {
        ...
        public FlowConnectionSnapshot[] flowConnections;
        public BlackboardPropertySnapshot[] blackboard;
    }

    [Serializable]
    public sealed class FlowConnectionSnapshot
    {
        public string fromNode;
