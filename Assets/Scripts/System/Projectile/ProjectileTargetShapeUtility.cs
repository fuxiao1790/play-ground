...
namespace PlayGround.System.Projectile
{
    public static class ProjectileTargetShapeUtility
    {
        ...
        public static ProjectileShapeType ShapeType(Collider2D collider)
        {
            return collider switch
            {
                CircleCollider2D => ProjectileShapeType.Circle,
                BoxCollider2D => ProjectileShapeType.Rectangle,
                CapsuleCollider2D => ProjectileShapeType.Capsule,
                null => ProjectileShapeType.Circle,
                _ => throw new global::System.ArgumentException($"Unsupported projectile shape collider type {collider.GetType().Name}.", nameof(collider))
            };
        }
