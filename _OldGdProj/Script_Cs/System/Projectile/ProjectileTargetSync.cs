...
/// <summary>
/// Synchronizes live Godot target nodes into plain ProjectileWorld target snapshots.
/// </summary>
internal sealed class ProjectileTargetSync
{
	...
	private TrackedTarget CreateTrackedTargetOrThrow(Node2D node)
	{
		...
		if (hurtboxShape == null || hurtbox == null)
		{
			throw new InvalidOperationException(
				$"Projectile target '{node.Name}' requires Hurtbox/HurtboxShape before it can be registered.");
		}
